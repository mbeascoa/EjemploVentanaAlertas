...
public class DialogoMensajeDosBotones extends DialogFragment {  //a esta clase le llama
...
//DE LOS RECURSOS DE DRAWABLE Y LO LLAMAREMOS //icmenutick.PNG  en minuscula
                ...
                .setNegativeButton("Cancelarrr",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                //TENDREMOS UN MÉTODO EN LA ACTIVIDAD
                                //LLAMADO ACCIONACEPTAR Y QUE NOS //PERMITIRÁ
                                //CAPTURAR LA ACCIÓN DE RESPUESTA.
                                ((MainActivity)getActivity()).accionCancelar();  //getactivity devuelve la actividad que me está llamando, pero como no sabe quien le llama la casteo
                                //accionAceptar está en el Mainctivity !!!
                            }
                        }
                )
